...
public class Listings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_listings);
                ...
                Date start1 = new Date(1967, 03, 04);
                Date end1 = new Date(1970, 03, 05);
                Date start2 = new Date(2017, 04, 06);
                Date end2 = new Date(2017, 12, 07);
                Date start3 = new Date(1960, 03, 02);
                Date end3 = new Date(1970, 05, 03);
                Date start4 = new Date(1980, 01, 01);
                Date end4 = new Date(1990, 01, 01);
                Date start5 = new Date(1900, 04, 02);
                Date end5 = new Date(1997, 05, 03);
                ...
                CourseListing course5 = new CourseListing("How to Succeed in Business",
                                                            ...
                                                            "Learn how to make money from others for only $1350!", start4, end4,
                                                            40392, 12);
